...
/**
 * まどか先生の英語の保健室：思考のスキャニングトレーニング
 * 共通テストの「抽象・具体」の言い換えに特化した20問トレーニングアプリ。
 * 外部DB不要、単一ファイルで完結しデプロイ可能です。
 */
  ...
  const allLevels = [
    {
      ...
      thinking: "個別の動物の名前を『小動物』というカテゴリーにまとめています。"
    },
    {
      type: "【具体 → 抽象】",
      ...
      thinking: "具体的な時刻を『日中』という時間概念に変換しています。"
    },
    {
      type: "【具体 → 抽象】",
      ...
      thinking: "『テスト・制御される』を『適切に評価（assessed）される』という概念に。2025年第5問の重要表現です。"
    },
    {
      type: "【具体 → 抽象】",
      ...
      thinking: "『許可不要』＝『自由に使える』という判断力を問う言い換えです。"
    },
    {
      type: "【具体 → 抽象】",
    ...
    },
    {
      ...
      answer: "twice a week",
      thinking: "特定の曜日を『週に何回』という頻度に抽象化しています。"
    },
    {
      type: "【具体 → 抽象】",
      ...
      thinking: "『徒歩10分以内』を『徒歩圏内』と言い換えています。"
    },
    {
      type: "【具体 → 抽象】",
      ...
      thinking: "『草（grass）』を『植物（vegetation）』という上位語に変換しています。"
    },
    {
      type: "【具体 → 抽象】",
      ...
      thinking: "『学生割引』を『学習者のための価格減免』と説明的に言い換えています。"
    },
    {
      type: "【具体 → 抽象】",
      ...
      answer: "adults only",
      thinking: "年齢制限を『大人限定』というカテゴリーに抽象化しています。"
    },
    {
      type: "【抽象 → 具体】",
      ...
      thinking: "『屋外活動』の具体的な中身を特定するトレーニングです。"
    },
    {
      type: "【抽象 → 具体】",
      ...
      thinking: "『医療施設』という言葉から、具体的な場所を想起します。"
    },
    {
      type: "【抽象 → 具体】",
      ...
      thinking: "『学業の成果』を具体的な成績や賞に関連付けます。"
    },
    {
      type: "【抽象 → 具体】",
    ...
    },
    {
      ...
      thinking: "カテゴリーを具体的な名前に分解する練習です。"
    },
    {
      type: "【抽象 → 具体】",
    ...
    },
    {
      ...
      thinking: "『季節の移り変わり』の中身を具体的に特定します。"
    },
    {
      type: "【抽象 → 具体】",
      ...
      thinking: "『緊急連絡先』という概念を具体的な機関に結びつけます。"
    },
    {
      type: "【抽象 → 具体】",
      ...
      thinking: "『自然災害』という抽象語を具体的な現象に翻訳します。"
    },
    {
      type: "【抽象 → 具体】",
      ...
      thinking: "『生活必需品』という言葉が何を指すかを判断します。"
    }
  ];
      ...
      <div className={`w-full max-w-md ${theme.card} rounded-[3.5rem] shadow-[0_30px_70px_rgba(180,160,140,0.2)] overflow-hidden border-8 border-white flex flex-col min-h-[720px] relative transition-all duration-700`}>
        ...
        {gameState === 'start' && (
          <div className="flex-grow flex flex-col items-center justify-center p-10 text-center relative z-10 animate-in fade-in duration-1000">
            ...
            <h2 className="text-3xl font-bold mb-5 tracking-tight leading-tight">思考のスキャニング<br/><span className="text-[#ffb7b2]">20問・100点満点</span></h2>
            <p className={`${theme.textSub} text-[14px] mb-12 leading-relaxed px-4 italic font-medium`}>
              「同じ単語」を探すのはもう卒業。<br/>
              解説をじっくり読んで、自分のペースで<br/>
              <b>「思考のブリッジ」</b>をマスターしましょう。🌿
            </p>
            <button
              onClick={startGame}
            ...
            >
              <Play fill="white" size={24} /> 特訓をはじめる
            </button>
          ...
          <div className="flex-grow flex flex-col p-8 relative z-10 animate-in fade-in duration-500">
            ...
            {!showThinkingPoint ? (
              <div className="grid grid-cols-1 gap-3.5 animate-in fade-in duration-300">
                <span className="text-[9px] font-bold text-[#b8a398] uppercase tracking-[0.2em] mb-2 ml-5 italic opacity-60">ふさわしい表現を選ぶ：</span>
        ...
        {gameState === 'result' && (
          <div className="flex-grow flex flex-col items-center justify-center p-12 animate-in zoom-in duration-1000 relative z-10 text-center">
            ...
            <h2 className="text-3xl font-bold mb-3 tracking-tighter leading-tight text-slate-800">特訓、おつかれさま🌿</h2>
            ...
            <div className="bg-[#fffcf8] p-8 rounded-[3rem] mb-12 w-full border-2 border-[#f5efeb] shadow-inner relative">
              <p className="text-[#8e7e74] text-[15px] leading-relaxed italic font-bold">
                {score === 100 
                  ? "【Sランク】完璧です！20の変換をすべてこなしたあなたは、もうどんな言い換えにも惑わされません。自信を持って扉を開けてくださいね。" 
                  : score >= 80
                  ? "【Aランク】素晴らしい！具体と抽象を繋ぐスピードが格段に上がっています。本番もそのリズムを大切に。"
                  : "【Bランク】よく頑張りました。一度間違えた『Thinking Point』をゆっくり見直すだけで、次はもっと楽に解けるようになりますよ。"}
              </p>
            </div>
            ...
            <div className="space-y-5 w-full px-4">
              ...
              >
                <RotateCcw size={14} /> 新しい問題セットで再挑戦
              </button>
              <a 
                href="#" 
              ...
              >
                まどか先生のNoteを読む <Heart size={22} fill="white" />
              </a>
            </div>
          </div>
        )}
